...
<div class="content">
<div class="content-kiri"><div style="width:110px; margin:200px auto 0;"><img src="images/mantap.png" /></div>
</div>
<div class="content-kanan"><div style="margin-top:185px; text-align:center;"><p><h2>Great!</h2><br />
<h3>To enjoy the website please click</h3>
<br />
</p>
<p><form action="plogin.php" method="post">
<input name="username" type="hidden" value="<? echo $_SESSION['uname']; ?>" />
<input name="password" type="hidden" value="<? echo $_SESSION['upass']; ?>" />
<input type="submit" value="ME" class="bgbut" /></form></p></div></div>
